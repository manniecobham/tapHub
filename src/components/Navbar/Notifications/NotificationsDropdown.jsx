...
import SpaceSelectionDropdown from "../../Overview/Content/DataType/Spaces/SpaceSelectionDropdown";
...
import { NotificationDropdownContainer } from "../../../styles/Navbar/Notifications/Notifications.styled";
  ...
  return (
    <NotificationDropdownContainer className="notifications-dropdown">
      <SpaceSelectionContainer ref={ref}>
        ...
        <Dropdown>
          {spaceDropdownIsShown && <SpaceSelectionDropdown id={props.id} />}
        </Dropdown>
