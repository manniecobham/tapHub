...
import { SidebarContentContainer } from "../../../../../../../styles/Overview/Content/DataType/Graph/GraphSidebar/GraphSidebar.styled";
    ...
    <SidebarContentContainer className={`${className}`}>
      <div className="sidebar-content__top">
        ...
        <div className="sidebar-content__top-value2">
          {arrow} {contextProp.data.value2}
          {changeUnits} {timeframe}
        </div>
      </div>
